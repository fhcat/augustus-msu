...
// 	}
   ...
   private:
	    ...
	    backward_mode(false)
	{
	    ...
	    switch (type) {
		case terminalHigh: case terminalMedium: case terminalLow: case singleGHigh: case singleGMedium: case singleGLow:    // subtract the stop codon
		    endStateOffset=-1; break;
		case initial1High: case initial1Medium: case initial1Low: case initial2High: case initial2Medium: case initial2Low:    // add the split codon 
		case internal1High: case internal1Medium: case internal1Low: case internal2High: case internal2Medium: case internal2Low:
		case rinternal0High: case rinternal0Medium: case rinternal0Low: case rinternal1High: case rinternal1Medium: case rinternal1Low:
		case rterminal1High: case rterminal1Medium: case rterminal1Low: case rterminal0High: case rterminal0Medium: case rterminal0Low:
		    endStateOffset=1; break;
		case initial0High: case initial0Medium: case initial0Low: case internal0High: case internal0Medium: case internal0Low:   // splicesite at codon end
		case rinternal2High: case rinternal2Medium: case rinternal2Low: case rinitialHigh: case rinitialMedium: case rinitialLow:
		case rterminal2High: case rterminal2Medium: case rterminal2Low: case rsingleGHigh: case rsingleGMedium: case rsingleGLow:   // reverse gene start at exon end
