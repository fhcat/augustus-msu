...
public:
  ...
  void addToEvaluation(Gene* prediction, Gene *database, AnnoSequence *annoseq, Strand strand, Double quotient = -1.0);
  void addToEvaluation(Gene* predictedGeneList, Gene* annotatedGeneList);
  void addToEvaluation(Gene* predictedGeneList, Gene* annotatedGeneList, AnnoSequence *annoseq);
