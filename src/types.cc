...
Boolean Constant::tieIgenicIntron = false;
...
{"intergenic region", 
 ...
 "5'UTR single exon high", "5'UTR single exon medium", "5'UTR single exon low", 
 "5'UTR initial exon high", "5'UTR initial exon mediun", "5'UTR initial exon low",
 "5'UTR intron", "5'UTR intron var", 
 "5'UTR internal exon high", "5'UTR internal exon medium", "5'UTR internal exon low", 
 "5'UTR terminal exon high", "5'UTR terminal exon medium", "5'UTR terminal exon low",
 "3'UTR single exon high", "3'UTR single exon medium", "3'UTR single exon low",
 "3'UTR initial exon high", "3'UTR initial exon medium", "3'UTR initial exon low",
 "3'UTR intron", "3'UTR intron var", 
 "3'UTR internal exon high", "3'UTR internal exon medium", "3'UTR internal exon low",
 "3'UTR terminal exon high", "3'UTR terminal exon medium", "3'UTR terminal exon low",
...
"reverse 5'UTR single exon high", "reverse 5'UTR single exon medium",  "reverse 5'UTR single exon low", 
"reverse 5'UTR initial exon high", "reverse 5'UTR initial exon medium", "reverse 5'UTR initial exon low",
"reverse 5'UTR intron", "reverse 5'UTR intron var", 
"reverse 5'UTR internal exon high", "reverse 5'UTR internal exon medium", "reverse 5'UTR internal exon low",
"reverse 5'UTR terminal exon high", "reverse 5'UTR terminal exon medium", "reverse 5'UTR terminal exon low", 
"reverse 3'UTR single exon high", "reverse 3'UTR single exon medium", "reverse 3'UTR single exon low", 
"reverse 3'UTR initial exon high", "reverse 3'UTR initial exon medium", "reverse 3'UTR initial exon low", 
"reverse 3'UTR intron", "reverse 3'UTR intron var", 
"reverse 3'UTR internal exon high", "reverse 3'UTR internal exon medium", "reverse 3'UTR internal exon low",
"reverse 3'UTR terminal exon high", "reverse 3'UTR terminal exon medium", "reverse 3'UTR terminal exon low",

 "intron", "reverse intron", "exon",
 "single exon high", "single exon medium", "single exon low", 
 "initial exon high 0", "initial exon medium 0", "initial exon low 0",
 "initial exon high 1", "initial exon medium 1", "initial exon low 1",
 "initial exon high 2", "initial exon medium 2", "initial exon low 2",
 "internal exon high 0", "internal exon medium 0", "internal exon low 0", 
 "internal exon high 1", "internal exon medium 1", "internal exon low 1", 
 "internal exon high 2", "internal exon medium 2", "internal exon low 2", 
 "terminal exon high", "terminal exon medium", "terminal exon low",
 "reverse single exon high", "reverse single exon medium", "reverse single exon low", 
 "reverse initial exon high", "reverse initial exon medium", "reverse initial exon low", 
 "reverse internal exon high 0", "reverse internal exon medium 0", "reverse internal exon low 0",
 "reverse internal exon high 1", "reverse internal exon medium 1", "reverse internal exon low 1", 
 "reverse internal exon high 2", "reverse internal exon medium 2", "reverse internal exon low 2",
 "reverse terminal exon high 0", "reverse terminal exon medium 0", "reverse terminal exon low 0",
 "reverse terminal exon high 1", "reverse terminal exon medium 1", "reverse terminal exon low 1",
 "reverse terminal exon high 2", "reverse terminal exon medium 2", "reverse terminal exon low 2"};
...
{"igenic",
 ...
 "utr5singleHigh", "utr5singleMedium", "utr5singleLow",
 "utr5initHigh", "utr5initMedium", "utr5initLow",
 "utr5intron", "utr5intronvar", 
 "utr5internalHigh", "utr5internalMedium", "utr5internalLow", 
 "utr5termHigh", "utr5termMedium", "utr5termLow",
 "utr3singleHigh", "utr3singleMedium", "utr3singleLow", 
 "utr3initHigh", "utr3initMedium", "utr3initLow", 
 "utr3intron", "utr3intronvar", 
 "utr3internalHigh", "utr3internalMedium", "utr3internalLow", 
 "utr3termHigh", "utr3termMedium", "utr3termLow",
 ...
 "rutr5singleHigh", "rutr5singleMedium", "rutr5singleLow", 
 "rutr5initHigh", "rutr5initMedium", "rutr5initLow", 
 "rutr5intron", "rutr5intronvar", 
 "rutr5internalHigh", "rutr5internalMedium", "rutr5internalLow",
 "rutr5termHigh", "rutr5termMedium", "rutr5termLow",
 "rutr3singleHigh", "rutr3singleMedium", "rutr3singleLow", 
 "rutr3initHigh", "rutr3initMedium", "rutr3initLow", 
 "rutr3intron", "rutr3intronvar", 
 "rutr3internalHigh", "rutr3internalMedium", "rutr3internalLow", 
 "rutr3termHigh", "rutr3termMedium", "rutr3termLow",
 
 "intron", "rintron", "exon",
 
 "singleHigh", "singleMedium", "singleLow", 
 "initial0High", "initial0Medium", "initial0Low",
 "initial1High", "initial1Medium", "initial1Low", 
 "initial2High", "initial2Medium", "initial2Low", 
 "internal0High", "internal0Medium", "internal0Low",
 "internal1High", "internal1Medium", "internal1Low",
 "internal2High", "internal2Medium", "internal2Low", 
 "terminalHigh", "terminalMedium", "terminalLow",
 "rsingleHigh", "rsingleMedium", "rsingleLow",
 "rinitialHigh", "rinitialMedium", "rinitialLow", 
 "rinternal0High", "rinternal0Medium", "rinternal0Low", 
 "rinternal1High", "rinternal1Medium", "rinternal1Low", 
 "rinternal2High", "rinternal2Medium", "rinternal2Low",
 "rterminal0High", "rterminal0Medium", "rterminal0Low",
 "rterminal1High", "rterminal1Medium", "rterminal1Low", 
 "rterminal2High", "rterminal2Medium", "rterminal2Low"};
...
{0,                        // intergenic region
 ...
 0,0,										   // reverse utr
 0,0,0,                    // other
 0,0,0,                    // forward exons "singleHigh", "singleMedium", "singleLow"
 0,0,0,                    // forward exons "initial0High", "initial0Medium", "initial0Low" 
 1,1,1,                    // forward exons "initial1High", "initial1Medium", "initial1Low"
 2,2,2,                    // forward exons "initial2High", "initial2Medium", "initial2Low"   
 0,0,0,                    // forward exons "internal0High", "internal0Medium", "internal0Low"  
 1,1,1,                    // forward exons "internal1High", "internal1Medium", "internal1Low"
 2,2,2,                    // forward exons "internal2High", "internal2Medium", "internal2Low" 
 0,0,0,                    // forward exons "terminalHigh", "terminalMedium", "terminalLow"
 2,2,2,                    // reverse exons "rsingleHigh", "rsingleMedium", "rsingleLow"
 2,2,2,                    // reverse exons "rinitialHigh", "rinitialMedium", "rinitialLow"
 0,0,0,                    // reverse exons "rinternal0High", "rinternal0Medium", "rinternal0Low" 
 1,1,1,                    // reverse exons "rinternal1High", "rinternal1Medium", "rinternal1Low" 
 2,2,2,                    // reverse exons "rinternal2High", "rinternal2Medium", "rinternal2Low"
 0,0,0,                    // reverse exons "rterminal0High", "rterminal0Medium", "rterminal0Low" 
 1,1,1,                    // reverse exons "rterminal1High", "rterminal1Medium", "rterminal1Low" 
 2,2,2};                   // reverse exons "rterminal2High", "rterminal2Medium", "rterminal2Low"       
